...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/paopaoya/updateTeam/master/shareCodes/jd_red.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/paopaoya/updateTeam@master/shareCodes/jd_red.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/paopaoya/updateTeam@master/shareCodes/jd_red.json')
  }
