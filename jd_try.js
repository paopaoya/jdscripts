...
const args = {
	...
	typeList: ["普通试用", "闪电试用"],
	// 商品过滤关键字
	goodFilters: "赠品@教程@流量@软件@货车@英语@辅导@培训小靓美@脚气@文胸@卷尺@种子@档案袋@癣@中年@老太太@妇女@私处@孕妇@卫生巾@卫生条@课@培训@阴道@生殖器@肛门@狐臭@网课@网校@电商@手机壳@钢化膜@车载充电器@网络课程@英语@俄语@四级@六级@四六级@在线网络@在线@阴道炎@宫颈@糜烂@手机膜@鱼@狗@看房游@手机卡".split('@'),
	// 商品最低价格
	minPrice: 0,
	// 商品提供最多的数量
	maxSupplyCount: 10,
