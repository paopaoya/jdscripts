...
let shareCodes = [
  '2FxlKcyWr_nSrRk-00USKw==@x2ukrVHolUDJPv26rXQIRg==@nxuaKRCOTTNWHuF1VPoWgQ==',//账号一的好友shareCode,不同好友中间用@符号隔开
  '2FxlKcyWr_nSrRk-00USKw==@x2ukrVHolUDJPv26rXQIRg==@nxuaKRCOTTNWHuF1VPoWgQ==',//账号二的好友shareCode，不同好友中间用@符号隔开
]
